...
/**
 * A page of cursor-paginated results returned by the CIC API.
 *
 * @param <T> the type of items in this page
 * @since 1.0.0
 */
public class CursorPageableResponse<T> {

    private final List<T> data;

    private final CursorPagination pagination;

    public CursorPageableResponse(List<T> data, CursorPagination pagination) {
