...
class IngestEventTest {
    ...
    void testToBuilderPreservesAllFields() {
        ...
        assertEquals(original.typedProperties(), copy.typedProperties());
    ...
    void testToBuilderAllowsOverride() {
        ...
        assertEquals("value2",
                ((IngestEventPropertyValue) modified.typedProperties().get("key2")).value().toJavaValue());
    }
    ...
    void testPropertiesReplacesExisting() {
        ...
        var event = builder.typedProperties(Map.of("key3", IngestEventPropertyValue.builder("value3").build())).build();

        assertEquals(1, event.typedProperties().size());
        assertEquals("value3", ((IngestEventPropertyValue) event.typedProperties().get("key3")).value().toJavaValue());
    }
    ...
    void testPutPropertiesAddsToExisting() {
        ...
        assertEquals(2, event.typedProperties().size());
        assertEquals("value1", ((IngestEventPropertyValue) event.typedProperties().get("key1")).value().toJavaValue());
        assertEquals("value2", ((IngestEventPropertyValue) event.typedProperties().get("key2")).value().toJavaValue());
    }
    ...
    void testReplaceProperties() {
        ...
        assertEquals("replaced-key1",
                ((IngestEventPropertyValue) replaced.typedProperties().get("key1")).value().toJavaValue());
        assertEquals("replaced-key2",
                ((IngestEventPropertyValue) replaced.typedProperties().get("key2")).value().toJavaValue());
    }
}
