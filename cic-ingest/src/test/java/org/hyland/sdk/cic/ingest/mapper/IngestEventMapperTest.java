...
class IngestEventMapperTest {
    ...
    @Test
    void testSerializeUnknownTypePropertyIsFlattenedWhenNoExtras() throws JSONException {
        var event = IngestEvent.builder(IngestEvent.Type.CREATE, "doc123")
                               .sourceId("source-1")
                               .date(Instant.ofEpochMilli(1609459200000L))
                               .putProperty("custom", IngestEventPropertyValue.builder((Object) "raw").build())
                               .build();
    ...
    @Test
    void testSerializeUnknownTypePropertyIsNotFlattenedWhenExtras() throws JSONException {
        var event = IngestEvent.builder(IngestEvent.Type.CREATE, "doc123")
                               .sourceId("source-1")
                               .date(Instant.ofEpochMilli(1609459200000L))
                               .putProperty("custom",
                                       IngestEventPropertyValue.builder((Object) "raw").annotation("name").build())
                               .build();
    ...
    void testSerializeIngestEventComplex1() throws JSONException {
        var event = IngestEvent.builder(IngestEvent.Type.CREATE_OR_UPDATE, "d71dd823-82c7-477c-8490-04cb0e826e65")
                               ...
                               .putProperty("createdAt",
                                       IngestEventPropertyValue.builder(Instant.parse("2021-01-21T11:14:15.695Z"))
                                                               .annotation("dateCreated")
                                                               .build())
                               .putProperty("nullValue", IngestEventPropertyValue.builderNull().build())
                               .putProperty("name",
                                       IngestEventPropertyValue.builder("purchase-order-scan.pdf")
                                                               .annotation("name")
                                                               .build())
                               .putProperty("aspectsNames",
                                       IngestEventPropertyValue.builder(new String[] { "versionable", "titled" })
                                                               .annotation("aspects")
                                                               .build())
                               .putProperty("content",
                                       IngestEventPropertyFile.builder()
                                                              ...
                                                              .build())
                               .putProperty("PERMISSIONS",
                                       IngestEventPropertyValue.builder(
                                               Map.of("read", List.of(Map.of("id", "GROUP_EVERYONE", "type", "GROUP")),
                                                       "deny", List.of(), "principalsType", "effective"))
    ...
    @Test
    void testSerializeFilePropertyWithoutIdThrows() {
        var event = IngestEvent.builder(IngestEvent.Type.CREATE, "doc123")
                               .sourceId("source-1")
                               .putProperty("content",
                                       IngestEventPropertyFile.builder().contentType("application/pdf").build())
                               .build();

        var exception = assertThrows(IllegalStateException.class, () -> MapperService.writeAsString(event));
        assertEquals("the file property 'content' has no id; upload the blob first via IngestService",
