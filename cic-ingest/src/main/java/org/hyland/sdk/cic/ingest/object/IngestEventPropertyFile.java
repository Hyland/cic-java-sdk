...
public final class IngestEventPropertyFile implements IngestEventProperty {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(id, other.id) && Objects.equals(contentType, other.contentType)
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, contentType, name, size, digest);
    }
    ...
    public static final class Builder {
        ...
        public IngestEventPropertyFile build() {
            ...
            if (blob != null && contentType == null) {
                throw new IllegalArgumentException("contentType must be provided when a blob is present");
            }
