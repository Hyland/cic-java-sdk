...
class ActionDescriptorMapper implements CICMapper<ActionDescriptor> {
    ...
    static class ListMapper implements CICMapper<ActionDescriptor.ListOf> {

        private final ActionDescriptorMapper innerMapper = new ActionDescriptorMapper();
        ...
        public ActionDescriptor.ListOf fromCICNode(CICNode cicNode) {
            ...
            return actionsArray.toListObject()
                               ...
                               .collect(Collectors.toCollection(ActionDescriptor.ListOf::new));
        }
    }
}
