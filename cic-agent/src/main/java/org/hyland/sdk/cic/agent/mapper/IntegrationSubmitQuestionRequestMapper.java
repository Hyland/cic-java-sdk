 ...
 * @since 1.0.0
 */
class IntegrationSubmitQuestionRequestMapper implements CICMapper<IntegrationSubmitQuestionRequest> {

    @Override
    public CICNode toCICNode(IntegrationSubmitQuestionRequest request) {
