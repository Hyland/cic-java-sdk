 ...
 * @since 1.0.0
 */
class DocumentReferencesMapper implements CICMapper<DocumentReferences> {

    private final ReferenceItemMapper itemMapper = new ReferenceItemMapper();

    @Override
    public DocumentReferences fromCICNode(CICNode cicNode) {
        ...
        var items = obj.getOptionalArray("references")
                       ...
                       .orElse(List.of());
        return new DocumentReferences(obj.getStringOrNull("documentId"), items);
    }
}
