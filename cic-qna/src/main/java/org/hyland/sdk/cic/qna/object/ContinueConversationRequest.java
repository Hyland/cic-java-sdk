 ...
 * @since 1.0.0
 */
public record ContinueConversationRequest(String question, List<String> contextObjectIds,
        FilterExpression dynamicFilter) {

    public ContinueConversationRequest {
    ...
    public static final class Builder {
        ...
        public ContinueConversationRequest build() {
            return new ContinueConversationRequest(question, contextObjectIds, dynamicFilter);
        }
    }
}
