 ...
 * @since 1.0.0
 */
class MessageCursorPageMapper implements CICMapper<MessagePage> {

    private final ConversationMessageMapper innerMapper = new ConversationMessageMapper();

    @Override
    public MessagePage fromCICNode(CICNode cicNode) {
